...
<body >
    ...
    <div class="col-5" style="border:0px solid black;border-radius:5%;box-shadow:rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset;">
        ...
        <i class='bx bxs-user' style="font-size:100px;"></i>
            ...
            <p style="font-family: 'Philosopher', sans-serif;">Don't have an account? <a href="signup.php">Sign in</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-danger" name="submit" style="font-family: 'Philosopher', sans-serif;">Sign Up</button></p><br>
        </form>
    </div>
</div>
</center>
